            ...
            <>
                ...
                <div className="board-wrapper">
                    ...
                    <div className="board-history">
                        <h2 className="board-heading">Move Recap:</h2>

                        {/* List with history of moves */}
                        <ul className="board-historyList">
                            {this.state.history.length === 0 && <span>Nothing happened yet.</span>}
                    ...
                    {winner && <div className="board-footer">
                        <button className="btn" onClick={this.handleBoardRestart}>Continue??</button>
                    </div>}
                </div>
            </>
        )
